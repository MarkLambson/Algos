...
console.log("Answer:", findConsqSums(nums1, sum1), " || Expected:", expected1)
console.log("Answer:", findConsqSums(nums2, sum2), " || Expected:", expected2)
console.log("Answer:", findConsqSums(nums3, sum3), " || Expected:", expected3)
console.log("Answer:", findConsqSums(nums4, sum4), " || Expected:", expected4)
console.log("Answer:", findConsqSums(nums5, sum5), " || Expected:", expected5)
/*****************************************************************************/